...
export default function NewListScreen() {
    ...
    const newsItems = newsResponse?.news || (Array.isArray(newsResponse) ? newsResponse : []);
    ...
    const getIcon = (type: string) => {
        switch (type) {
            case 'hero-image': return <ImageIcon size={20} color="#3b82f6" />;
            case 'bullet-list': return <List size={20} color="#10b981" />;
            case 'quote-block': return <Quote size={20} color="#f59e0b" />;
            default: return <Newspaper size={20} color="#7c3aed" />;
        }
    };
        ...
        <View className="flex-1 bg-[#fdfdfc] dark:bg-[#121212]">
            ...
            >
                ...
                >
                    ...
                    >
                        Administra y controla el contenido informativo de la plataforma desde un solo lugar.
                    </Text>
                    ...
                    <View className="min-w-[850]">
                        ...
                        <View className="flex-row border-b border-gray-100 dark:border-gray-800 pb-4 mb-4 px-4">
                            ...
                            <View className="flex-[3] w-24">
                                <Text style={{ fontFamily: 'Inter_700Bold' }} className="text-[#64748b] text-[10px] tracking-widest uppercase">Contenido</Text>
                            </View>
                            <View className="flex-[1.5] w-24 text-left">
                                <Text style={{ fontFamily: 'Inter_700Bold' }} className="text-[#64748b] text-[10px] tracking-widest uppercase">Formato</Text>
                            </View>
                            <View className="flex-[1.5] w-24 text-left">
                            ...
                            {newsItems.length > 0 ? (
                                newsItems.map((item: any, index: number) => (
                                    ...
                                    >
                                        ...
                                        {/* Category Label */}
                                        <View className="flex-[1.5] w-24 text-left">
                                            <Text style={{ fontFamily: 'Inter_400Regular' }} className="text-xs text-[#64748b] dark:text-[#9ca3af]">
                                ...
                                <View className="p-20 items-center">
                                    <Newspaper size={48} color="#cbd5e1" strokeWidth={1} />
                                    <Text style={{ fontFamily: 'Inter_500Medium' }} className="mt-4 text-[#94a3b8]">No hay noticias publicadas aún.</Text>
                                </View>
                            )}
                        </View>
                    </View>
                    ...
                    <View className="bg-white dark:bg-[#1a1a1a] w-full max-w-md rounded-[40px] p-8 shadow-2xl border border-white/10">
                        <View className="items-center mb-8">
                            ...
                            <Text style={{ fontFamily: 'Inter_400Regular' }} className="text-[#64748b] dark:text-[#9ca3af] text-center mt-3 leading-6 px-4">
                                Esta acción eliminará permanentemente la noticia <Text style={{ fontFamily: 'Inter_700Bold' }} className="text-[#ef4444]">"{selectedNews?.title}"</Text>. Los datos no se podrán recuperar.
                            </Text>
                        </View>
